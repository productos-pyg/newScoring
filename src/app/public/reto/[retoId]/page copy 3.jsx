...
export default function PublicRetoDetail({ params }) {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Filtramos calificaciones de fase clasificatoria
        const calificacionesClasificatoria = resultadosRes.data.filter(calificacion => {
          // Es de clasificatoria si:
          // 1. No tiene emparejamiento
          // 2. Tiene múltiples intentos
  ...
  // ... renderPodioFinal se mantiene igual ...
